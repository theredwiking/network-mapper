...
var rootCmd = &cobra.Command{
	Use:   "netmap",
	Short: "A tool for mapping a network",
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.network-mapper.yaml)")
